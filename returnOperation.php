...
class TsReturnOperation extends ReferencesOperation
{
     ...
     *
     * @return array The result of the operation containing status of notifications.
     * @throws Exception if there are missing or invalid data elements.
     */
    public function doOperation(): array
    {
        ...
        if ($notificationType === self::TYPE_CHANGE && !empty($data['differences']['to']) && !empty($client->mobile)) {
